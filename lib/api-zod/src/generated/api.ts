...
export const ListMatchesResponseItem = zod.object({
  ...
  "possessionSource": zod.enum(['official', 'veo', 'unknown']).describe('Whether this individual match statistic was manually recorded, backfilled from Veo, or predates provenance tracking.'),
  "shots": zod.number().nullish(),
  "shotsSource": zod.enum(['official', 'veo', 'unknown']).describe('Whether this individual match statistic was manually recorded, backfilled from Veo, or predates provenance tracking.'),
  "passes": zod.number().nullish(),
  "passesSource": zod.enum(['official', 'veo', 'unknown']).describe('Whether this individual match statistic was manually recorded, backfilled from Veo, or predates provenance tracking.'),
  "oppShots": zod.number().nullish(),
  "oppShotsSource": zod.enum(['official', 'veo', 'unknown']).describe('Whether this individual match statistic was manually recorded, backfilled from Veo, or predates provenance tracking.'),
  "oppPasses": zod.number().nullish(),
  "oppPassesSource": zod.enum(['official', 'veo', 'unknown']).describe('Whether this individual match statistic was manually recorded, backfilled from Veo, or predates provenance tracking.'),
...
export const GetMatchReportResponse = zod.object({
  ...
  "source": zod.union([zod.enum(['official', 'veo', 'unknown']).describe('Whether this individual match statistic was manually recorded, backfilled from Veo, or predates provenance tracking.'),zod.null()]).describe('Source of this match-only statistic. Null for official scoreline tiles that do not use match-stat provenance.')
})),
  ...
  "passes": zod.number().optional(),
  "possessionSource": zod.enum(['official', 'veo', 'unknown']).optional().describe('Whether this individual match statistic was manually recorded, backfilled from Veo, or predates provenance tracking.'),
  "shotsSource": zod.enum(['official', 'veo', 'unknown']).optional().describe('Whether this individual match statistic was manually recorded, backfilled from Veo, or predates provenance tracking.'),
  "passesSource": zod.enum(['official', 'veo', 'unknown']).optional().describe('Whether this individual match statistic was manually recorded, backfilled from Veo, or predates provenance tracking.'),
  "seasonAvgPasses": zod.number().nullish(),
...
export const listLibraryPracticesResponseReviewCropsItemWMin = 20;
...
export const ListLibraryPracticesResponseItem = zod.object({
  ...
  "reviewCrops": zod.array(zod.object({
  "x": zod.number(),
  "y": zod.number(),
  "w": zod.number().min(listLibraryPracticesResponseReviewCropsItemWMin),
  "h": zod.number().min(listLibraryPracticesResponseReviewCropsItemHMin)
}).describe('Crop rectangle in diagram canvas coordinates (960x720 standard)')).max(listLibraryPracticesResponseReviewCropsMax).describe('Coach\'s snips; multiple entries = variations worked through in order'),
  "reviewPart": zod.string().nullish().describe('warmup | activation | introduction | main | endgame | unusable; null = not yet reviewed'),
...
export const reviewLibraryPracticeBodyCropsItemWMin = 20;

export const reviewLibraryPracticeBodyCropsItemHMin = 20;
...
export const ReviewLibraryPracticeBody = zod.object({
  ...
  "x": zod.number(),
  "y": zod.number(),
  "w": zod.number().min(reviewLibraryPracticeBodyCropsItemWMin),
  "h": zod.number().min(reviewLibraryPracticeBodyCropsItemHMin)
}).describe('Crop rectangle in diagram canvas coordinates (960x720 standard)')).max(reviewLibraryPracticeBodyCropsMax).optional()
})
...
export const CreateSessionResponse = zod.object({
  ...
  "x": zod.number(),
  "y": zod.number(),
  "w": zod.number().min(createSessionResponsePartsItemPracticeOneReviewCropsItemWMin),
  "h": zod.number().min(createSessionResponsePartsItemPracticeOneReviewCropsItemHMin)
}).describe('Crop rectangle in diagram canvas coordinates (960x720 standard)')).optional()
}),zod.null()]).optional(),
...
export const GenerateSessionBody = zod.object({
  ...
  "includeActivation": zod.boolean().optional().describe('Also fill the passing activation slot from the coach\'s tagged activations')
})
...
export const GenerateSessionResponse = zod.object({
  ...
  "x": zod.number(),
  "y": zod.number(),
  "w": zod.number().min(generateSessionResponsePartsItemPracticeOneReviewCropsItemWMin),
  "h": zod.number().min(generateSessionResponsePartsItemPracticeOneReviewCropsItemHMin)
}).describe('Crop rectangle in diagram canvas coordinates (960x720 standard)')).optional()
}),zod.null()]).optional(),
  "rules": zod.string().nullish(),
  "tasks": zod.string().nullish(),
...
export const GetSessionResponse = zod.object({
  ...
  "x": zod.number(),
  "y": zod.number(),
  "w": zod.number().min(getSessionResponsePartsItemPracticeOneReviewCropsItemWMin),
  "h": zod.number().min(getSessionResponsePartsItemPracticeOneReviewCropsItemHMin)
}).describe('Crop rectangle in diagram canvas coordinates (960x720 standard)')).optional()
}),zod.null()]).optional(),
  "rules": zod.string().nullish(),
  "tasks": zod.string().nullish(),
...
export const UpdateSessionResponse = zod.object({
  ...
  "x": zod.number(),
  "y": zod.number(),
  "w": zod.number().min(updateSessionResponsePartsItemPracticeOneReviewCropsItemWMin),
  "h": zod.number().min(updateSessionResponsePartsItemPracticeOneReviewCropsItemHMin)
}).describe('Crop rectangle in diagram canvas coordinates (960x720 standard)')).optional()
}),zod.null()]).optional(),
  "rules": zod.string().nullish(),
  "tasks": zod.string().nullish(),
...
export const upsertSessionPartResponsePartsItemPracticeOneReviewCropsItemWMin = 20;
...
export const UpsertSessionPartResponse = zod.object({
  ...
  "x": zod.number(),
  "y": zod.number(),
  "w": zod.number().min(upsertSessionPartResponsePartsItemPracticeOneReviewCropsItemWMin),
  "h": zod.number().min(upsertSessionPartResponsePartsItemPracticeOneReviewCropsItemHMin)
}).describe('Crop rectangle in diagram canvas coordinates (960x720 standard)')).optional()
}),zod.null()]).optional(),
  "rules": zod.string().nullish(),
  "tasks": zod.string().nullish(),
...
export const ClearSessionPartResponse = zod.object({
  ...
  "x": zod.number(),
  "y": zod.number(),
  "w": zod.number().min(clearSessionPartResponsePartsItemPracticeOneReviewCropsItemWMin),
  "h": zod.number().min(clearSessionPartResponsePartsItemPracticeOneReviewCropsItemHMin)
}).describe('Crop rectangle in diagram canvas coordinates (960x720 standard)')).optional()
}),zod.null()]).optional(),
  "rules": zod.string().nullish(),
  "tasks": zod.string().nullish(),
...
export const GetLastMeetingFactsQueryParams = zod.object({
  "seasonId": zod.coerce.number(),
  "opponent": zod.coerce.string().min(1)
})

export const GetLastMeetingFactsResponse = zod.object({
