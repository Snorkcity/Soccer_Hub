...
**Shape boxes are real tables:** game-day print sheet's 3 grey boxes are 5×7 PPTX tables (header cell = formation, XI mapped into cells by px/py, GK bottom middle) so the coach can edit them in PowerPoint after download.
