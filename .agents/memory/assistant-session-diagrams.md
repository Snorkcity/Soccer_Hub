---
name: Assistant session diagrams (parked)
description: Planned feature — Coach Assistant answers include the matching practice-library diagram per practice; parked until coach commits time.
---

**Idea:** when the Coach Assistant delivers a session, look up each chosen practice in the practice library and embed its SVG/diagram in the chat answer (library already holds rendered diagrams; custom GPT never could).
