...
- **Why**: coach's public custom GPT was being overused; instructions (Croatian 3-phase output, content preservation, scope enforcement) are baked into the system prompt in `routes/assistant.ts` — do not soften them.
