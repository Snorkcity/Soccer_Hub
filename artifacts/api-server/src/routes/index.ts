...
import gpsPlayerEmailsRouter from "./gpsPlayerEmails";
import gpsMatchReportsRouter from "./gpsMatchReports";
...
router.use(gpsPlayerEmailsRouter);
router.use(gpsMatchReportsRouter);
